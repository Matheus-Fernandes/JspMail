...
.vertical-menu a.active {
    ...
    <form action="encaminharMensagem.jsp">
        <div class = "corpo">
            <m:campo label="Destinatário" nome="destinatario" tipo="text"/> <br>
            Assunto: <m:campo_preenchido label="Assunto" nome="assunto" tipo="text"/>${sessionScope.mensagem.assunto.toString()}
            

            <div class="form-group">
                <label for="texto"></label>
                <textarea class="form-control" 
                          id="conteudo" name="conteudo" rows="20" readonly="true">${sessionScope.mensagem.conteudo}</textarea>
            </div>
